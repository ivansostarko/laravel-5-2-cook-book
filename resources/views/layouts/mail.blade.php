...
<div class="wrapper" style="min-width: 320px;background-color: #ededf1;" lang="x-wrapper">
    ...
    <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);" id="emb-email-header-container">
        ...
        <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
            <div class="logo-center" style="font-size:0px !important;line-height:0 !important;" align="center" id="emb-email-header"><img style="height: auto;width: 100%;border: 0;max-width: 275px;" src="../../../public/images/logo-email.png" alt="" width="275" /></div>
        </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
    </div>
        ...
        <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" emb-background-style>
            ...
            <div class="column" style='text-align: left;color: #7c7e7f;font-size: 14px;line-height: 21px;font-family: "PT Serif",Georgia,serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);'>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
                   <h1 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #3e4751;font-size: 22px;line-height: 31px;font-family: Ubuntu,sans-serif;text-align: center;">@yield('contentheader_title', 'Header')</h1><p style="Margin-top: 20px;Margin-bottom: 20px;"></p>
                </div>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px; Margin-bottom:30px">
                    ...
                    <h2 class="size-16" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #3e4751;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;" lang="x-size-16"></h2><p style="Margin-top: 16px;Margin-bottom: 0;">@yield('main-content')</p>
                </div>
