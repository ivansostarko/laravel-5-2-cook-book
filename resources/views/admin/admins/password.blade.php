...
@section('main-content')
    ...
    <form id="editPasswordForm" class="form-horizontal" role="form" method="POST" action="{{ url('/admin/admins/password/update', $admin->id) }}">
        {{ csrf_field() }}
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input id="password" type="password"  class="form-control" name="password" placeholder="{{ trans('words.edit_password') }}">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-2">
                <label for="inputPassword3" class="control-label">{{ trans('words.confirm_password') }}</label>
            </div>
            <div class="col-sm-10">

                <input id="password2" type="password"  class="form-control" name="password2" placeholder="{{ trans('words.confirm_password') }}">
            </div>
        </div>
