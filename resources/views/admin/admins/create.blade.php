...
@section('main-content')
    ...
    <form class="form-horizontal"  id="registerForm" role="form" method="POST" action="{{ url('/admin/admins/store') }}">
        {!! csrf_field() !!}
        ...
        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" id="name" placeholder="{{ trans('words.name') }}" name="name" value="{{ old('name') }}">
        ...
        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input type="password" class="form-control" placeholder="{{ trans('words.password') }}" id="password" name="password">
        ...
        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
            <label class="col-md-4 control-label" name="password_confirmation1">{{ trans('words.confirm_password') }}</label>

            <div class="col-md-6">
                <input type="password" class="form-control" id="password_confirmation" placeholder="{{ trans('words.confirm_password') }}" name="password_confirmation">
